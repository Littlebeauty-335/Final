    ...
    <div className={classes.root}>
      ...
      >
        <Grid item xs={12} sm={12} md={6} >
            ...
            <p style={{fontSize:'15px', paddingLeft:'80px', }}>From routine doctor visits to the most advanced procedures. Our Doctor specialize  Trauma, Deformity correction, Limb lengthening, Arthroscopy and Sports Medicine.
             </p>
            </Grid>
